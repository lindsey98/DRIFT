...
from prompts import CONSTRAINTS_BUILD_PROMPT, TOOL_CALLING_PROMPT, INJECTION_DETECTION_PROMPT, ADAPTIVE_ATTACK_PROMPT, ALIGN_CLAIM_PROMPT, ALIGN_CLAIM_PREFIX, CLOSE_TAG_PREFIX, CLOSE_TAG_SUFFIX, CLOSE_TAG_SUFFIX
